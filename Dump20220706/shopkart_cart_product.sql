...
CREATE TABLE `cart_product` (
  ...
  KEY `FKeuyu0w1vavuvx6v8g8jb8vx3w` (`product_product_id`),
  KEY `FKk3n97uli3cvoj6o0dcnnm7a8e` (`cart_cart_id`),
  CONSTRAINT `FKeuyu0w1vavuvx6v8g8jb8vx3w` FOREIGN KEY (`product_product_id`) REFERENCES `products` (`product_id`),
...
INSERT INTO `cart_product` VALUES (1,1),(1,3),(2,4),(2,5);
